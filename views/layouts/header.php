...
<head>
    ...
    <link type="image/png" href="/template/img/logo.png" rel="icon">
...
<body class="d-flex flex-column">
    <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-center">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a id="list_menu_item" class="nav-link" href="/">Список задач <i class="fas fa-list"></i></a>
            </li>
            <li class="nav-item">
                <a id="create_menu_item" class="nav-link" href="task/create">Добавить задачу <i class="fas fa-plus"></i></a>
            </li>
